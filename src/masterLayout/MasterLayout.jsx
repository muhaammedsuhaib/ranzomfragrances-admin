      ...
      >
        ...
        <div>
          <Link href="/" className="sidebar-logo">
            <img
              src="assets/images/ranzomblacklogo.png"
              alt="site logo"
              className="light-logo"
            />
            <img
              src="assets/images/ranzomlogowhite.png"
              alt="site logo"
              className="dark-logo"
            />
            <img
        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
              ...
              <ul className="sidebar-submenu">
                <li>
                  <Link
                    href="/product-list"
                    className={
                      pathname === "/product-list" ? "active-page" : ""
                    }
                  >
                    <i className="ri-circle-fill circle-icon text-primary-600 w-auto" />
                    Product List
            ...
            <li className="dropdown">
              <Link href="#">
                <Icon icon="mdi:cube-scan" className="menu-icon" />
